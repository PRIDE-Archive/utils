...
public enum ProjectTag {
    ...
    BD_CANCER_HUMAN_PROTEOME_PROJECT ("Cancer (B/D-HPP)", "Cancer (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_CV_HUMAN_PROTEOME_PROJECT ("Cardiovascular (B/D-HPP)", "Cardiovascular (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_DIABETES_HUMAN_PROTEOME_PROJECT ("Diabetes (B/D-HPP)", "HDPP (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_EPIGENETIC_HUMAN_PROTEOME_PROJECT ("Epigenetic Chromatin (B/D-HPP)", "Epigenetic Chromatin (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_EXTREME_CONDITIONS_HUMAN_PROTEOME_PROJECT ("Extreme Conditions (B/D-HPP)", "Extreme Conditions (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_EYEOME_HUMAN_PROTEOME_PROJECT ("EyeOME (B/D-HPP)", "EyeOME (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_FOOD_NUTRITION_HUMAN_PROTEOME_PROJECT ("Food and Nutrition (B/D-HPP)", "FaN (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_GLUCOPROTEOMICS_HUMAN_PROTEOME_PROJECT ("Glycoproteomics (B/D-HPP)", "HGPI (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_IMMUNO_PEPTIDOMEHUMAN_PROTEOME_PROJECT ("Human Immuno-Peptidome Project (HUPO-HIPP)", "HIPP (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_iMOP_HUMAN_PROTEOME_PROJECT ("iMOP (B/D-HPP)", "iMOP (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_KIDNEY_URINE_HUMAN_PROTEOME_PROJECT ("Kidney Urine (B/D-HPP)", "HKUPP (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_LIVER_HUMAN_PROTEOME_PROJECT ("Liver (B/D-HPP)", "HLPP (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
    BD_PEPIOME_HUMAN_PROTEOME_PROJECT ("PediOME (B/D-HPP)", "PediOME (B/D-HPP)", ProjectTagType.PARENT_PROJECT),
